@extends('layouts.app')
@section('title', 'Register POS Terminal')
@section('shortText', 'Register and configure a cashiering POS terminal for your store')
@section('content')
    <x-page-header />
                        ...
                        <div class="d-flex align-items-center gap-3">
                            ...
                            <div>
                                ...
                                <div style="color: rgba(255,255,255,0.9); font-size: 0.88rem;">
                                    POS Terminals Used: <span class="badge bg-warning text-dark fw-bold px-2.5 py-1 ms-1 fs-6">{{ $deviceCheck['current'] }} / {{ $deviceCheck['limit'] }} Allowed</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div>
                            @if(!$deviceCheck['allowed'])
                                <a href="{{ route('subscription.checkout') }}" class="btn btn-warning fw-bold px-4 py-2.5 rounded-3 text-dark shadow d-inline-flex align-items-center gap-2">
                                    ...
                                    <span>Upgrade Plan for More Terminals</span>
                                </a>
                            @else
                                <div class="d-flex align-items-center gap-2 px-3 py-2 rounded-pill shadow-sm" style="background: rgba(255,255,255,0.18) !important; border: 1px solid rgba(255,255,255,0.3) !important;">
                                    ...
                                    <span class="fw-bold text-white small" style="color: #ffffff !important;">Terminal Slots Available</span>
                                </div>
                            @endif
                        </div>
                    </div>
                ...
                <div class="card border shadow-sm rounded-4 mb-4" style="background: #ffffff !important; border-color: #e2e8f0 !important;">
                        ...
                        <div class="d-flex align-items-center mb-4 pb-3 border-bottom">
                            ...
                            <div>
                                ...
                                <div class="text-muted small">
                                    I-configure ang POS terminal (counter, checkout workstation, o mobile station) para sa cashiering.
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row g-3 mb-3">
                            <div class="col-md-6">
                                <label for="terminal_name" class="form-label fw-bold text-dark small mb-1">
                                    Terminal Name / Counter Label <span class="text-danger">*</span>
                                </label>
                                <input type="text" 
                                       id="terminal_name" 
                                       name="terminal_name" 
                                       class="form-control rounded-3 py-2 px-3 border" 
                                       placeholder="e.g. Counter 1 / Main Checkout POS-01" 
                                       value="{{ old('terminal_name') }}" 
                                       required
                                       style="border-color: #cbd5e1 !important;">
                                <div class="form-text extra-small text-muted">
                                    Pangalan ng counter o terminal para madaling ma-identify ng cashier.
                                </div>
                            </div>
                        ...
                        <div class="row g-3">
                            <div class="col-md-6">
                                <label for="status" class="form-label fw-bold text-dark small mb-1">
                                    Terminal Status <span class="text-danger">*</span>
                                </label>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" 
                                       ...
                                       name="remarks" 
                                       class="form-control rounded-3 py-2 px-3 border" 
                                       placeholder="e.g. Counter 1 Hardware Station" 
                                       value="{{ old('remarks') }}"
                                       style="border-color: #cbd5e1 !important;">
                            </div>
                        </div>
                    ...
                    <div class="card-footer bg-light px-4 py-3 d-flex flex-column flex-sm-row justify-content-between align-items-sm-center gap-3 border-top" style="border-color: #e2e8f0 !important;">
                        <small class="text-muted">
                            <i class="bi bi-shield-check text-success me-1"></i> Ang bawat POS terminal ay may konektadong cash drawer para sa audit trail.
                        </small>
                        ...
                        <div class="d-flex gap-2">
                            ...
                            @else
                                <a href="{{ route('subscription.checkout') }}" class="btn btn-warning px-4 py-2.5 rounded-3 fw-bold text-dark shadow-sm d-flex align-items-center gap-2">
                                    <i class="bi bi-arrow-up-circle-fill fs-5"></i>
                                    <span>Upgrade Plan to Register Terminal</span>
                                </a>
                            @endif
                        </div>
                    </div>
