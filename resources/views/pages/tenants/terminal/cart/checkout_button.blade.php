<div class="checkout-section mt-2">
    @if($isSalePaid ?? false)
        <div class="d-flex flex-column gap-2">
            <button
                type="button"
                class="btn btn-primary w-100 py-3 rounded-3 fw-extrabold shadow d-flex align-items-center justify-content-center gap-2"
                id="btnPrintPastSaleReceipt"
                style="background: linear-gradient(135deg, #2563eb, #1d4ed8); border: none; font-size: 1.05rem;"
            >
